            ...
            <div className="footer">
                ...
                <div className="footer-third">
                        <ul className="social-media-icons">
                            ...
                            <li><Link target="_blank"  rel="noreferrer" to="https://www.linkedin.com/in/saurabh-ojha-14598912b/"> <img className="social-media-icons-image" src={require("../assets/images/social media icons/5296501_linkedin_network_linkedin logo_icon.png")} height={"50px"} width={"50px"} alt="Linkdin"  /> </Link></li>
