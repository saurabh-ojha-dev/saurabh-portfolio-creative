        ...
        <header className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
            ...
            <div className="w-full flex justify-between items-center lg:hidden">
                ...
                <nav className="flex items-center justify-center flex-wrap">
                    ...
                    <motion.a
                        href="https://github.com/saurabh-ojha-dev"
                        target={'_blank'}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mx-3"
                    ...
                    <motion.a
                        href="https://linkedin.com/in/saurabh-ojha-dev"
                        target={'_blank'}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mx-3"
                    ...
                    {/* <motion.a
            href="https://saurabh-portfolio-creative.netlify.app"
            target={'_blank'}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          >
            <PinterestIcon />
                    ...
                    <motion.a
                        href="https://x.com/saurabh28745675"
                        // href="mailto:sourabhojih12@gmail.com"
                        target={'_blank'}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 ml-3"
